...
<div class="container-fluid text-center" id="c-start">    
    ...
    <div class="col-sm-8 text-left"> 
		...
		?>
		<?php  $result = mysql_query("SELECT * FROM onam WHERE category='veg' and special='onam'"); ?>
		<div class="row">
		...
		<?php  $result = mysql_query("SELECT * FROM onam WHERE category='nonveg' and special='onam'"); ?>
		<div class="row">
